...
class PredictorApp(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Model Predictor")
        self.setGeometry(100, 100, 600, 400)

        self.init_ui()

        self.model_paths = {
            "Decision Tree": os.path.join(os.path.dirname(sys.argv[0]), 'decision_tree_mmodel.joblib'),
            "Random Forest": os.path.join(os.path.dirname(sys.argv[0]), 'random_forest_mmodel.joblib')
        }
    ...
    def create_model_selection(self, layout):
        ...
        self.model_selector.addItems(["Decision Tree", "Random Forest"])
